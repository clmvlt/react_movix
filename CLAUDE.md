...
- Multi-entreprises : une identite web (`userId` non-null dans login / `/auth/me`) peut
  ...
  "Entreprises" du hyperadmin (`hyper-members-panel.tsx`), pas par ce formulaire.
...
- Hyperadmin multi-entreprises : domaine `src/features/members/`
  ...
  par entreprise sans restriction ; DELETE = retrait. UI : onglet "Entreprises" du
