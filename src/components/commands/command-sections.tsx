...
import { CommandPharmacyCard } from "@/components/commands/command-pharmacy-card";
...
import type { CommandBasic, CommandDetail } from "@/features/commands";
  ...
  return (
    <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
      ...
      <CommandRecentCard
        ...
        hasPharmacy={Boolean(command.pharmacy?.cip)}
