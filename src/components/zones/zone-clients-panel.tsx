...
interface ZoneClientsPanelProps {
  title: string;
  ...
  onTogglePage: (clientIds: string[], checked: boolean) => void;
...
export function ZoneClientsPanel({
  title,
  isUnassigned,
  search,
  onSearchChange,
      ...
      <div className="flex shrink-0 items-center gap-1.5">
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className="truncate text-xs text-muted-foreground">
            {t("zones.clientCount", { count: data?.totalElements ?? 0 })}
          </p>
        </div>
        <Button
                  ...
                  <TableHead className="w-10">
                    <Checkbox
                      ...
                      onCheckedChange={(value) =>
                        onTogglePage(pageIds, value === true)
                      }
